...
This GitHub Respo is a condensed version of a practical and applied statistics project 'What Effect Does the Depth of an Artic Lake Have On Its Sediment Composition?' I conducted during my BSc Mathematics and Statistics degree. For reference, this project was awarded first-class marks.
...
There are two files detailing the code written for this project. 
